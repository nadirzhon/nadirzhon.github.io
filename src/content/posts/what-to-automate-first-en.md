---
title: 'What to automate first: a method that takes one evening'
description: 'How to pick the process whose automation pays back, and tell it apart from the one that merely annoys you. Four columns and the ten-minute rule.'
lang: 'en'
date: 2026-07-14
...
1. How many times a week does someone do it?
2. Does it take roughly the same time every time?

...
export const t = {
  ...
  formService: { ru: 'С чем нужна помощь', en: 'What you need' } as Dict,
  formServiceHint: {
    ru: 'Выберите направление — так я сразу пойму, о чём речь. Если не подходит ни одно, берите «Другая задача».',
    en: 'Pick a direction so I know what we are talking about. If none fits, choose “Something else”.',
  } as Dict,
  formServiceOther: { ru: 'Другая задача', en: 'Something else' } as Dict,
  formServiceOtherNote: {
    ru: 'Опишу словами — разберёмся вместе',
    en: 'I’ll describe it — we’ll figure it out',
  } as Dict,
  formServiceMissing: {
    ru: 'Выберите направление — это первый шаг формы',
    en: 'Pick a direction — that is the first step of the form',
  } as Dict,
  formServiceMore: { ru: 'Подробнее об услуге', en: 'More about this service' } as Dict,
  formStepService: { ru: 'Направление', en: 'Direction' } as Dict,
  formStepContacts: { ru: 'Контакты', en: 'Contacts' } as Dict,
  formStepTask: { ru: 'Задача', en: 'The task' } as Dict,
